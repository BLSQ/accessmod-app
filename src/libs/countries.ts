// Copied from https://gist.github.com/incredimike/1469814
...
export const countries: Country[] = [
  ...
  { code: "BS", alpha3: "BHS", name: "Bahamas (the)" },
  ...
  { code: "BN", alpha3: "BRN", name: "Brunei Darussalam" },
  ...
  { code: "KY", alpha3: "CYM", name: "Cayman Islands (the)" },
  {
    code: "CF",
    alpha3: "CAF",
  ...
  { code: "KM", alpha3: "COM", name: "Comoros (the)" },
  {
    code: "CD",
    alpha3: "COD",
    name: "Congo (the Democratic Republic of the)",
  },
  { code: "CG", alpha3: "COG", name: "Congo (the)" },
  { code: "CK", alpha3: "COK", name: "Cook Islands (the)" },
  ...
  { code: "DO", alpha3: "DOM", name: "Dominican Republic (the)" },
  ...
  { code: "FO", alpha3: "FRO", name: "Faroe Islands (the)" },
  ...
  { code: "GM", alpha3: "GMB", name: "Gambia (the)" },
  ...
  { code: "VA", alpha3: "VAT", name: "Holy See (the)" },
  ...
  { code: "KR", alpha3: "KOR", name: "Korea (the Republic of)" },
  ...
  { code: "MH", alpha3: "MHL", name: "Marshall Islands (the)" },
  ...
  { code: "PS", alpha3: "PSE", name: "Palestine, State of" },
  ...
  { code: "PH", alpha3: "PHL", name: "Philippines (the)" },
  ...
  { code: "RU", alpha3: "RUS", name: "Russian Federation (the)" },
  ...
  { code: "SD", alpha3: "SDN", name: "Sudan (the)" },
  ...
  { code: "SY", alpha3: "SYR", name: "Syrian Arab Republic" },
  ...
  { code: "VN", alpha3: "VNM", name: "Viet Nam" },
